...
export const closure2133_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__ha1dd6968fe906a53: (a: number, b: number) => void;
export const closure2681_externref_shim: (a: number, b: number, c: any) => void;
export const closure2605_externref_shim: (a: number, b: number, c: any, d: any) => void;
